 ...
 * clean JSON error responses, so the API never returns ugly stack traces.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleMembershipError(MembershipException ex) {
